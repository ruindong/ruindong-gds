 ...
 */
var DM_goods_comments= function(){
    MessageMachine.call(this);
    //url
    this.url ='http://api.dfhon.cn/v3/Activity.json?action=GetCouponCommentListByCouponId&app_sdk=gds&app_version=1.0.0&app_terminal=pc';
    this._template = '<div class="discuss_item">\
                            <div class="discuss_item_header">\
                                <img class="user_photo" src="{{UserFace}}">\
                                <div class="user_name"><span>{{UserNickName}}</span><span>{{UpdateTime}}</span></div>\
