...
template.helper('getSmpFormatDateByLong', function (l, isfull) {
	return getSmpFormatDateByLong(l, isfull);
});
...
template.helper('getCover', function (images) {
	return getCover(images);
});
